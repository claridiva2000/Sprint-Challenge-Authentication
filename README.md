...
bcrypt uses a modified key setup algorithm which is timely quite expensive. This is called key strengthening, and makes a password more secure against brute force attacks
1. What does bcrypt do to slow down attackers?
since the attacker now needs a lot more time to test each possible key.
